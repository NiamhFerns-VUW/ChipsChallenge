...
import nz.ac.vuw.ecs.swen225.gp22.persistency.LevelMap;

/**
 * Acts as source of truth for levels currently.
 */
    ...
    public static Map<Coord, Cell> getMap2() {
        ...
        // --------------------------------------------
        {
            ...
            level2map.put(new Coord(7,5),new Cell(
                new FreeTile(),
                new ArrayList<>(List.of(new CustomMonsterProvider(Direction.None,new Coord(7,5))))
            ));
